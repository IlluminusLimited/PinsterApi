...
ActiveRecord::Schema.define(version: 20_180_422_231_140) do
  ...
  create_table 'collectable_collections', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[collectable_type collectable_id collection_id], name: 'index_collectable_collections_on_type_id_and_col_id', unique: true
